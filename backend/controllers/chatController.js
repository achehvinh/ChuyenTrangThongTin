...
const EXPERT_KNOWLEDGE = [
  ...
  },
  {
    ...
    reply: `💸 HƯỚNG DẪN XỬ LÝ KHẨN CẤP KHI LỠ CHUYỂN TIỀN CHO KẺ LỪA ĐẢO:\n\n` +
           ...
           `3. Bước 3 (Báo Công an): Đến trực tiếp Trụ sở Công an xã hoặc gọi Hotline: 0339310915 để lực lượng Công an lập hồ sơ phối hợp Ngân hàng phong tỏa tài khoản đối tượng lừa đảo.`
  },
  {
