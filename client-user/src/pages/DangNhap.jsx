      ...
      <div className="user-login-card">
        ...
        <div className="user-login-right">
          <svg width="100%" height="100%" viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="390" y="245" fontFamily="Arial" fontSize="16" fontWeight="bold" fill="#d97706" text-anchor="middle">$</text>
            
            <circle cx="430" cy="180" r="12" fill="#fbbf24" stroke="#d97706" strokeWidth="2"/>
            <text x="430" y="184" fontFamily="Arial" fontSize="12" fontWeight="bold" fill="#d97706" text-anchor="middle">$</text>

            <circle cx="440" cy="280" r="14" fill="#fbbf24" stroke="#d97706" strokeWidth="2"/>
            <text x="440" y="285" fontFamily="Arial" fontSize="14" fontWeight="bold" fill="#d97706" text-anchor="middle">$</text>
          </svg>
        </div>
      </div>
    </div>
