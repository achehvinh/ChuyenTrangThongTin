...
const BUBBLE_MESSAGES = {
  '/phong-chong-lua-dao': 'Hỏi Trợ lý AI Phòng VH-XH về cách nhận biết & tố giác lừa đảo mạng?',
  '/an-toan-giao-thong': 'Hỏi Trợ lý AI Phòng VH-XH về luật an toàn giao thông & mức phạt?',
  '/thien-tai': 'Hỏi Trợ lý AI Phòng VH-XH về kỹ năng ứng phó lũ quét & sạt lở?',
  '/bau-cu': 'Hỏi Trợ lý AI Phòng VH-XH về địa điểm bỏ phiếu & quyền cử tri?',
  '/huong-dan-vneid': 'Hỏi Trợ lý AI Phòng VH-XH cách kích hoạt & dùng VNeID Mức 2?',
  '/te-nan': 'Hỏi Trợ lý AI Phòng VH-XH cách phòng ngừa ma túy & tố giác tệ nạn?',
